...
// paperDataTower contains tower/Tenrouirai configuration parameters (DataType 5).
var paperDataTower = []PaperData{
...
// paperDataTowerScaling contains tower floor scaling tables (DataType 6).
